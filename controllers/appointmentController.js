...
const createAppointment = [
    ...
    asyncHandler(async (req, res) => {
        ...
        const { date, timeStart, timeEnd, totalPrice, salon, customer, services, combos, staff, paymentStatus, paymentMethod, paymentInfo } = req.body;
        try {
            const newAppointment = new Appointment({
                ...
                paymentStatus,
                paymentMethod,
                paymentInfo: paymentInfo ? (paymentInfo?._id || (await new Payment(paymentInfo).save())._id) : null
            });
...
const updateAppointment = [
    ...
    asyncHandler(async (req, res) => {
        ...
        try {
            ...
            const { date, timeStart, timeEnd, totalPrice, salon, customer, services, combos, staff, paymentStatus, paymentMethod, paymentInfo, status } = req.body;
